...
- Added a feature to spam the chat. Press F to toggle. Message to be spammed can be set in settings > chat > chat spam message. 
...
-![](https://raw.githubusercontent.com/blockyfish-client/Desktop-Client/master/img/loading.gif)
